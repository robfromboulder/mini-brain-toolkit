...
2. **Disk → read index.** Every top-level `.md` file (excluding `CLAUDE.md`, `README.md`, `CONTRIBUTING.md`, and this file) appears in the read index. The index is grouped in two blocks (product, then own-brain) — check both. Flag orphans.
