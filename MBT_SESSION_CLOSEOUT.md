...
**Content rules:** trace the lineage turn-by-turn (don't summarize the destination); filenames and section names are fine but no line numbers or other drift-prone specifics; skip anything re-derivable from the files themselves; don't restate scope or approach.
