...
**Critical evidence gaps** (absence is itself a result):
...
- *Readiness probes* — keep a curated set of questions (never cached answers) the dream must answer with high confidence from brain + code; a question it can't answer is the result.
